...
→ Post-game fossils / legendaries (optioneel)</pre>
  ...
  <div class="callout tip">
    ...
    <p>Giovanni’s <strong>eerste</strong> win geeft één Ancient DNA. Mew-shrine-chests kunnen ook Ancient DNA bevatten. <strong>Origin Fossil</strong> (Mew) craften <em>verbruikt</em> Ancient DNA (REI: DNA + fossils + Ancient Origin Ball). <strong>Mewtwo</strong> heeft óók Ancient DNA + cloning catalyst nodig — dus beide routes samen vragen om twee DNA.</p>
  </div>
