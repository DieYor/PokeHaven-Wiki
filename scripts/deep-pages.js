...
export function registerDeepPages({
  ...
  writePage("Common_Mistakes.html", {
    ...
    <table class="wikitable">
      ...
      <tbody>
        <tr class="critical-row"><td>Wrong pack version</td><td>Cannot join</td><td>Re-import shared 1.7.42 zip from <a href="${DISCORD_INVITE}" rel="noopener noreferrer" target="_blank">Discord</a></td></tr>
        ...
        <tr class="critical-row"><td>No claim</td><td>Items stolen/broken</td><td><a href="Claims.html">FTB Chunks</a> before valuables</td></tr>
        <tr class="critical-row"><td>Right-click Empty Map</td><td>Cannot craft gym map</td><td>New Empty Map + <a href="Gym_Maps.html">cartography table</a></td></tr>
        <tr class="critical-row"><td>Hand-breaking seagrass</td><td>0 Cerulean Star mats</td><td>Use Shears — <a href="Misty.html">Misty</a></td></tr>
        <tr><td>Buying only luxury shop gear</td><td>Broke</td><td>Craft balls; sell emeralds</td></tr>
        <tr><td>Palace before gyms</td><td>Slow progress</td><td>Gyms first — <a href="Brock.html">Brock</a></td></tr>
        <tr class="critical-row"><td>Wrong Pokémon selected</td><td>Wrong mon sent out</td><td>Arrow keys then <kbd>R</kbd></td></tr>
        <tr class="critical-row"><td>Old IP from a screenshot</td><td>Cannot connect</td><td>Copy IP from Discord <code>#how-to-join</code></td></tr>
    ...
    <p class="see-also"><strong>See also:</strong> <a href="FAQ.html">FAQ</a> · <a href="${DISCORD_INVITE}" rel="noopener noreferrer" target="_blank">Discord</a></p>
    ${navboxSystems()}
    `,
  });
