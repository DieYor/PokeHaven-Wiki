...
export function registerDeepPages({
  ...
  writePage("Postgame_and_Legendaries.html", {
    ...
    <tr><th>Ancient DNA</th><td>Giovanni 1st win · Mew shrine chests</td></tr>
  ...
  writePage("Fossils_and_Resurrection.html", {
    ...
    lede: "Find fossils, build the Cobblemon machines, revive every standard and Galar form, then tackle Origin Fossil and Ancient DNA.",
